...
# 4- Define the output root folder path for the .rou.xml file
output_root_folder = test_files_path = os.path.join(os.pardir, "training_network/")

# 5- Define simulation time 
simulation_time = 9600

traffic_generator = TrafficGenerator(simulation_time,f'{output_root_folder}osm-new.rou.xml')
